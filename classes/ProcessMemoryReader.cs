...
namespace Memory.classes
{
    ...
    {
        public static uint OffsetCalculator(classes.MemoryHelper32 TargetMemory, uint BaseAddress, int[] Offsets)
        {
        ...
        public static ulong OffsetCalculator(classes.MemoryHelper64 TargetMemory, ulong BaseAddress, int[] Offsets)
        {
            var address = BaseAddress;
            foreach (uint offset in Offsets)
            {
